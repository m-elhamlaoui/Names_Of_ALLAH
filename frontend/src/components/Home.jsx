...
const Home = ({ setRefs }) => {
  ...
  id="home"
  ref={homeRef}
  className="sticky top-0 h-screen w-full bg-home bg-cover bg-center bg-fixed flex flex-col justify-center items-center"
>
  <div className="B overflow-auto absolute bottom-0 left-1/2 -translate-x-1/2 w-full text-center">
    <h4 className="text-white font-bold font-serif">
    ...
    <button className="btn"> <a href="/quiz">Go to the Quiz</a></button>
      ...
      <section id="about" ref={aboutRef} className="w-full">
        <div className="paragh">
          ...
          <p className='font-serif'>
            ...
            prayers. For any questions or further assistance, please feel free
            to contact us.
          </p>
        </div>
      </section>
